    ...
    <div class="l-navbar text-bg-danger" id="nav-bar">
        <nav class="nav">
            <div class="container-fluid">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="volunteer_home.php"><i class="fa fa-user" aria-hidden="true"></i>
                            Profile</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="col-md-8">
            ...
            <form name="f1" onsubmit="return validation()" action="script/add_volunteer.php" method="post">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-danger btn-block mb-4">Submit</button>
